<?php
    ...
    $sql = mysqli_query($con,"SELECT * FROM products WHERE clasificacion = 'nacional' ORDER BY nombre_producto ASC");
    ...
    if(isset($_POST['boton'])){
        ...
        if (!empty($_POST['nombre']) &&
            ...
            !empty($_POST['mensaje']))
            {
                mail($destinatario,"Consulta desde pagina web (Venezuela)", $contenido);
...
<html lang="es">
    <head>
        <title>El Gran Pegaso - Venezuela</title>
        <meta charset="UTF-8">
        ...
        <meta itemprop="name" content="El Gran Pegaso - Venezuela">
        ...
        <meta itemprop="image" content="https://www.elgranpegaso.com/img/Logo-Meta-VE.jpg">

        <!-- Facebook - WhatsApp Meta Tags -->
        <meta property="og:site_name" content="El Gran Pegaso - Venezuela" />
        <meta property="og:url" content="https://www.elgranpegaso.com">
        <meta property="og:type" content="website">
        <meta property="og:title" content="El Gran Pegaso - Venezuela">
        ...
        <meta property="og:image" itemprop="image" content="https://www.elgranpegaso.com/img/Logo-Meta-VE.jpg">

        <!-- Twitter Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@<?php echo $row_perfil['twitter'] ?>">
        <meta name="twitter:title" content="El Gran Pegaso - Venezuela">
        ...
        <meta name="twitter:image" content="https://www.elgranpegaso.com/img/Logo-Meta-VE.jpg">
                ...
                <div class="Banner">
                    <div id="slides">
                        <ul class="slides-container">
                            ...
                            <li>
                                <section class="Promo-1 Fondo-2">
                                    <div class="Contenedor-SS">
                                        <div class="Lado-Iz-2 animated fadeInUp Delay-2">
                                        </div>
                                        <div class="Lado-Der-2">
                                            <p class="Premisa Color-2 animated fadeinDown Delay-1 ">¡Nuevo!</p>
                                            <h2 class="Titulo-Premisa Color-2 animated fadeinDown Delay-1">Separador de juntas</h2>
                                            <a class="btn-premisa-2 animated fadeinDown Delay-1" href="#">Ver detalles</a>
                                        </div>
                                    </div>
                                </section>
                            </li>
                            <li>
                                <section class="Promo-1 Fondo-1VE">
                                  <div class="Contenedor-SS">
                                    <div class="Lado-Iz">
                                      <p class="Premisa animated fadeInUp">Conoce</p>
                                      <h2 class="Titulo-Premisa animated fadeInUp Delay-1">Pego Blanco</h2>
                                      <a class="btn-premisa animated fadeInUp Delay-1" href="#">Ver detalles</a>
                                    </div>
                                    <div class="Lado-Der-VE  animated slideInRight Delay-1">
                                    </div>
                                  </div>
                              </section>
                            </li>
                            <li>
                                <section class="Promo-1 Fondo-3VE">
                                  <div class="Contenedor-SSW">
                                      <p class="Premisa animated fadeInUp">Nosotros</p>
                                      <h2 class="Titulo-Premisa animated fadeInUp Delay-1">Creemos en Venezuela</h2>
                ...
                <div class="Contenedor">
                    ...
                    <div class="Contenedor-Modo-De-Uso">
                        <div class="Modo-De-Uso">
                            <a onclick="openNav()" class="tooltip">$
                        ...
                        <div id="myNav" class="overlay">
                            ...
                            <div class="overlay-content">
                                ...
                                <a href="#Productos">De venta en Venezuela</a>
                ...
                <div class="Contenedor">
                    ...
                    <div class="Contenedor-inputs animado-1">
                        <form action="" method="post" class="Formulario-Consulta">
                            ...
                            <textarea placeholder="Escriba su mensaje aqui" maxlength="320" minlength="50" name="mensaje" required></textarea>
