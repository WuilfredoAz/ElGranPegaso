...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">DENTILAB C.A.</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
         <li class="<?php echo $active_inicio;?>"><a href="inicio.php"><i class='glyphicon glyphicon-modal-window'></i> Inicio</a></li>
    ...
    <li class="<?php echo $active_reportes;?>"><a href="reportes_productos.php"><i  class='glyphicon glyphicon-list-alt'></i> Reportes</a></li>
	 <?php if($rango == 2){?>
    ...
    <li class="<?php echo $active_respaldos;?>"><a href="respaldos.php"><i  class='glyphicon glyphicon-tasks'></i> Respaldos</a></li>
    <?php } ?>
